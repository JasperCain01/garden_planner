...
| 3.7 Plot-image export                           | ⬜ not started | Blocked on 4.1/4.2 (icons). Stage 4.1 is the more honest "next stage" — see [`docs/stage-4.1-brief.md`](./docs/stage-4.1-brief.md)                                                    |
...
Stage 4.1's icon set hasn't landed yet).
