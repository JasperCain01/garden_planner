...
| 3.7 Plot-image export                           | ⬜ not started | Blocked on 4.2 (icons need wiring in first). Icons themselves (4.1) are now built — see [`docs/stage-4.2-brief.md`](./docs/stage-4.2-brief.md)                                                                         |
