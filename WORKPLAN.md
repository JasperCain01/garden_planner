...
**Stages 6.0 and 6.1 are complete** (see above and the stage entries below),
leaving 6.2 (accessibility & responsive polish), 6.3 (final validation) and
6.4 (CI, deliberately last).
