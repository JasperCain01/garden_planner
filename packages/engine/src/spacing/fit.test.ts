 ...
 *   kale    45 × 45 cm rows,  no intensive figure (like 151 of the 160 records)
 */
...
/** A crop with row spacing only — the shape 151 of the 160 shipped records have. */
...
describe('choosing a growing method', () => {
  ...
  it('derives an intensive figure from row spacing, conservatively, and says so', () => {
    // Kale has no intensive block — like 151 of the 160 shipped records. Its
